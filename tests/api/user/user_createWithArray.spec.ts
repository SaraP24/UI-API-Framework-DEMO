...
test.describe('Create Multiple Users from Array', () => {
  test('should successfully create multiple users from an array of user data', async ({ userApiClient, assertionsApi }) => {
    const users = [
    ...
    const response = await userApiClient.createUsersWithArray(users);
